				...
				<div class="container">
					<div class="columns is-vcentered">
						...
						<div class="column is-offset-1">
							...
							<div class="content box"><strong>THIRM PROTOCOL</strong> is a collection of tools, contracts, and solvers that enables non-ERC20 cryptocurrencies (like BTC, LTC, HTR, NANO, etc.) partake in the DeFi edge, facilitating cross-chain lending, DEX trading, collateralization and more.</div>
