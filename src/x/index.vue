				...
				<div class="container">
					<div class="columns is-vcentered">
						...
						<div class="column is-offset-1">
							...
							<div class="subtitle box"><strong>THIRM PROTOCOL</strong> enables non-ERC20 cryptocurrencies (like BTC, LTC, HTR, NANO, etc.) partake in the DeFi edge, facilitating cross-chain lending, DEX trading, collateralization and more.</div>
							<hr />
							<social />
						</div>
					</div>
